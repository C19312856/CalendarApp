sap.ui.define([
	...
	function(Label, Popover, coreLibrary, DateFormat, Fragment, Controller, JSONModel, Log) {
		...
		return Controller.extend("com.myorg.calendarappointment.controller.Page", {

			onInit: function () {
				var oModel = new JSONModel();
				oModel.setData({
					startDate: new Date("2022", "0", "13", "8", "0"),
					people: [{
						...
						appointments: [
							{
								start: new Date("2022", "0", "8", "08", "30"),
								end: new Date("2022", "0", "8", "09", "30"),
								title: "Meet Samuel Davies",
								type: "Type02",
								tentative: false
							},
							{
							...
							{
								start: new Date("2022", "0", "13", "08", "30"),
								end: new Date("2022", "0", "13", "09", "30"),
								title: "Meet Samuel Davies",
								type: "Type02",
								tentative: false
							},
							{
								start: new Date("2022", "0", "13", "10", "0"),
							...
							{
								start: new Date("2022", "0", "13", "11", "30"),
								end: new Date("2022", "0", "13", "13", "30"),
								title: "Lunch",
								info: "canteen",
								type: "Type03",
								tentative: true
							...
							{
								start: new Date("2022", "0", "13", "13", "30"),
								end: new Date("2022", "0", "13", "17", "30"),
						...
						headers: [
							{
								start: new Date("2022", "0", "13", "8", "0"),
								end: new Date("2022", "0", "13", "10", "0"),
								title: "Reminder",
								type: "Type06"
							},
							{
								start: new Date("2022", "0", "13", "17", "0"),
								end: new Date("2022", "0", "13", "19", "0"),
								title: "Reminder",
								type: "Type06"
							},
							{
					...
					},
						{
							...
							appointments: [
								...
								{
									start: new Date("2022", "0", "13", "08", "00"),
									end: new Date("2022", "0", "13", "09", "30"),
									title: "Discussion of the plan",
									info: "Online meeting",
									type: "Type04",
								...
								{
									start: new Date("2022", "0", "13", "18", "00"),
									end: new Date("2022", "0", "13", "19", "10"),
									title: "Discussion of the plan",
									info: "Online meeting",
									type: "Type04",
									tentative: false
							...
							headers: [
								{
									start: new Date("2022", "0", "13", "9", "0"),
									end: new Date("2022", "0", "13", "10", "0"),
									title: "Payment reminder",
									type: "Type06"
								},
								{
									start: new Date("2022", "0", "13", "16", "30"),
									end: new Date("2022", "0", "13", "18", "00"),
						...
						},
						{
							...
							appointments: [
								...
								{
									start: new Date("2022", "0", "13", "13", "00"),
									end: new Date("2022", "0", "13", "16", "00"),
									title: "Discussion with clients",
									info: "online",
									type: "Type02",
									tentative: false
			...
			handleEditButton: function(){
				var oDetailsPopover = that.byId("detailsPopover");
				this.sPath = oDetailsPopover.getBindingContext().getPath();
				oDetailsPopover.close();
				that._arrangeDialogFragment(that._aDialogTypes[2].type);
			...
			_handleGroupAppointments: function (oEvent) {
				...
				if (!this._oGroupPopover) {
					...
					that._oGroupPopover.getContent()[0].setText(sGroupPopoverValue);
				}
